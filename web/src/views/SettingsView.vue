...
watch(cfg, (c) => {
  ...
  form.forceChinese = c.values.forceChinese !== false;
...
async function save() {
  ...
  try {
    const patch = {
      ...
      forceChinese: form.forceChinese,
  ...
  <div>
    ...
    <template v-else-if="cfg">
      ...
      <div class="card">
        ...
        <div class="setting-row">
          <div>
            <div class="setting-label">{{ t('settings.forceChinese') }}</div>
            <div class="hint">{{ t('settings.forceChineseDesc') }}</div>
          </div>
          <label class="switch">
            <input type="checkbox" v-model="form.forceChinese" />
            <span class="slider"></span>
          </label>
        </div>
      </div>
